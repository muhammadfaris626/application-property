                ...
                <div class="grid xl:grid:cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-4">
                    ...
                    <div>
                        <flux:field>
                            ...
                            <flux:select wire:model="to_area_id" variant="listbox" placeholder="Pilih Area" :options="$fetchArea" :selectedData="$this->to_area_id" />
                            <flux:error name="to_area_id" />
                        </flux:field>
                    </div>
                </div>
            </div>
            <flux:custom.confirm-update :route="route('mutasi.index')" />
        </form>
    </div>
</app>
