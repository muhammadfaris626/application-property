<app>
    ...
    <div class="grid grid-cols-1">
        <form wire:submit.prevent="update">
            <flux:heading size="xl" class="px-4 pb-2">Ubah Permintaan Material</flux:heading>
            <div class="border rounded-lg p-4 dark:border-white/10">
                <div class="grid xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-4">
                    <div>
                        <flux:input wire:model="ro_number" label="Nomor RO" badge="Otomatis" disabled />
                    </div>
                    <div>
            ...
            <flux:custom.confirm-update :route="route('permintaan-material.index')" />
        </form>
    </div>
</app>
