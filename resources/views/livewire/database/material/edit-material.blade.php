                ...
                <div class="grid xl:grid:cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-4">
                    <div>
                        <flux:field>
                            ...
                            <flux:select wire:model="material_category_id" variant="listbox" placeholder="Pilih Kategori Material" :options="$fetchData" :selectedData="$this->material_category_id" />
