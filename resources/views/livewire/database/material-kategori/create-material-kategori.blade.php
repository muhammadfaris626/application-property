<app>
    <div class="flex flex-col md:flex-row gap-6 justify-between md:items-center mb-6">
        <flux:breadcrumbs>
            ...
            <flux:breadcrumbs.item :href="route('material-kategori.index')" divider="slash">Material Kategori</flux:breadcrumbs.item>
        ...
        <form wire:submit.prevent="store">
            <div class="border rounded-lg p-4">
                <div class="grid xl:grid:cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-4">
                    <div>
                        <flux:input wire:model="code" label="Kode" badge="Required" disabled />
                    </div>
                    <div>
            ...
            <flux:custom.confirm-create :route="route('material-kategori.index')" />
        </form>
    </div>
</app>
