<app>
    <div class="flex flex-col md:flex-row gap-6 justify-between md:items-center mb-2">
        <flux:breadcrumbs>
            ...
            <flux:breadcrumbs.item divider="slash">Data Jaminan User</flux:breadcrumbs.item>
        </flux:breadcrumbs>
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
            <div class="md:col-span-1 flex flex-col gap-4">
                <div class="relative rounded-lg p-4 bg-zinc-50 dark:bg-zinc-700">
                    <flux:subheading>Total Data Jaminan User</flux:subheading>
                    <flux:heading size="sm">{{ $totalDajamUser }}</flux:heading>
                </div>
                <div class="relative rounded-lg p-4 bg-zinc-50 dark:bg-zinc-700">
                    <flux:subheading>Total Terverifikasi</flux:subheading>
                    <flux:heading size="sm">{{ $totalTerverifikasi }}</flux:heading>
                </div>
                <div class="relative rounded-lg p-4 bg-zinc-50 dark:bg-zinc-700">
                    <flux:subheading>Total Belum Terverifikasi</flux:subheading>
                    <flux:heading size="sm">{{ $totalBelumTerverifikasi }}</flux:heading>
                </div>
            </div>
            <div class="md:col-span-2 flex flex-col gap-4">
                <div class="relative flex-1 rounded-lg bg-zinc-50 text-center px-4 pt-4">
                    <flux:custom.column-chart-basic :data="$columnChartDajam" :title="'Data Jaminan User'" :label="'dajam-user'" :useRupiah="false" />
                </div>
            </div>
            <div class="md:col-span-2 flex flex-col gap-4">
                <div class="relative flex-1 rounded-lg bg-zinc-50 text-center px-4 pt-4">
                    <flux:custom.column-chart-basic :data="$columnChartDajamYears" :title="'Data Jaminan User'" :label="'data-jaminan-user'" :useRupiah="false" />
                </div>
            </div>
        </div>
    </div>
