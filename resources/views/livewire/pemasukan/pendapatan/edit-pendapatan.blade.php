        ...
        <form wire:submit.prevent="update">
            <div class="border rounded-lg p-4 dark:border-white/10">
                <div class="grid xl:grid:cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-4">
                    ...
                    <div>
                        <flux:field>
                            ...
                            <flux:select wire:model="type_of_income_id"
                                ...
                                :selectedData="$type_of_income_id" />
                    ...
                    <div x-data="{ total: @entangle('total').live }" x-init="total = total?.toString().replace(/\B(?=(\d{3})+(?!\d))/g, '.')">
            ...
            <flux:custom.confirm-update :route="route('pemasukan-pendapatan.index')" />
        </form>
    </div>
</app>
