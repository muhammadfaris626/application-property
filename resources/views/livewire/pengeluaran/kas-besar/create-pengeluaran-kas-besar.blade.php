<app>
    <div class="flex flex-col md:flex-row gap-6 justify-between md:items-center mb-6">
        <flux:breadcrumbs>
            ...
            <flux:breadcrumbs.item :href="route('pengeluaran-kas-besar.index')" divider="slash">Kas Besar</flux:breadcrumbs.item>
    ...
    <div class="grid grid-cols-1">
        <form wire:submit.prevent="store">
            ...
            <flux:custom.confirm-create :route="route('pengeluaran-kas-besar.index')" />
        </form>
    </div>
    <script>
