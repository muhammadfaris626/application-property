<app>
    <div class="flex flex-col md:flex-row gap-6 justify-between md:items-center mb-6">
        <flux:breadcrumbs>
            ...
            <flux:breadcrumbs.item :href="route('persetujuan.show', $approval_flow_id)" divider="slash">Persetujuan</flux:breadcrumbs.item>
    ...
    <div class="grid grid-cols-1">
        <form wire:submit.prevent="update">
                ...
                <div class="grid xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-4">
                    ...
                    <div>
                        <flux:field>
                            ...
                            <flux:select wire:model="area_id" variant="listbox" placeholder="Pilih Area" :options="$fetchArea" :selectedData="$area_id" />
                    ...
                    <div>
                        <flux:field>
                            ...
                            <flux:select wire:model="position_id" variant="listbox" placeholder="Pilih Jabatan" :options="$fetchPosition" :selectedData="$position_id" />
            ...
            <flux:custom.confirm-update :route="route('persetujuan.show', $approval_flow_id)" />
        </form>
    </div>
</app>
