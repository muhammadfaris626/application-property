...
return new class extends Migration
{
    ...
    {
        Schema::create('list_kas_kecils', function (Blueprint $table) {
            $table->id();
            $table->foreignId('kas_kecil_id')->constrained('kas_kecils')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('list_kas_kecils');
    }
};
