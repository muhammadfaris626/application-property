...
class TerminationPolicy
{
    ...
    {
        return $user->hasPermissionTo('pemberhentian: menu');
    }
    ...
    {
        return $user->hasPermissionTo('pemberhentian: read');
    }
    ...
    {
        return $user->hasPermissionTo('pemberhentian: create');
    }
    ...
    {
        return $user->hasPermissionTo('pemberhentian: update');
    }
    ...
    {
        return $user->hasPermissionTo('pemberhentian: delete');
    }
