...
class ApprovalFlowPolicy
{
    ...
    {
        return $user->hasPermissionTo('persetujuan: menu');
    }
    ...
    {
        return $user->hasPermissionTo('persetujuan: read');
    }
    ...
    {
        return $user->hasPermissionTo('persetujuan: create');
    }
    ...
    {
        return $user->hasPermissionTo('persetujuan: update');
    }
    ...
    {
        return $user->hasPermissionTo('persetujuan: delete');
    }
